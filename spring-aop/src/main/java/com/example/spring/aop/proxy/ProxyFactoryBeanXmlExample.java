 ...
 */
public class ProxyFactoryBeanXmlExample {

    private static final Logger LOGGER = LoggerFactory.getLogger(ProxyFactoryBeanXmlExample.class);

    public static void main(String[] args) {
        AnnotationConfigApplicationContext annotationConfigApplicationContext =
                new AnnotationConfigApplicationContext(ProxyFactoryBeanXmlConfig.class);
