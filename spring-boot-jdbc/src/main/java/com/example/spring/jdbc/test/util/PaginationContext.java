...
public class PaginationContext {
    ...
    private static final ThreadLocal<Integer> pageNum = new ThreadLocal<Integer>();     // 保存第几页
    private static final ThreadLocal<Integer> pageSize = new ThreadLocal<Integer>();    // 保存每页记录条数
